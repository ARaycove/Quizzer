...
class TodayMcqIncorrectAttempts extends StatField{
  static final TodayMcqIncorrectAttempts _instance = TodayMcqIncorrectAttempts._internal();
  factory TodayMcqIncorrectAttempts() => _instance;
  TodayMcqIncorrectAttempts._internal();

  @override
  String get name => "today_mcq_incorrect_attempts";
  ...
  @override
  String get description => "Number of incorrect Multiple Choice attempts made today.";
  ...
  Future<int> recalculateStat({Transaction? txn, bool? isCorrect, double? reactionTime, String? questionId, String? questionType}) async {
    try {
      ...
      // If we have a new incorrect answer for an MCQ question, increment
      ...
      QuizzerLogger.logError('Failed to recalculate today_mcq_incorrect_attempts: $e');
      rethrow;
    }
  }
  ...
  Future<int> calculateCarryForwardValue({Transaction? txn, Map<String, dynamic>? previousRecord, Map<String, dynamic>? currentIncompleteRecord}) async {
    try {
      ...
      QuizzerLogger.logError('Failed to calculate carry-forward for today_mcq_incorrect_attempts: $e');
      rethrow;
    }
  }
}