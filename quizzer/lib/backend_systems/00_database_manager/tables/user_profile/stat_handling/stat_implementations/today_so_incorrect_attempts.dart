...
class TodaySoIncorrectAttempts extends StatField{
  static final TodaySoIncorrectAttempts _instance = TodaySoIncorrectAttempts._internal();
  factory TodaySoIncorrectAttempts() => _instance;
  TodaySoIncorrectAttempts._internal();

  @override
  String get name => "today_so_incorrect_attempts";
  ...
  @override
  String get description => "Number of incorrect Sort Order attempts made today.";
  ...
  Future<int> recalculateStat({Transaction? txn, bool? isCorrect, double? reactionTime, String? questionId, String? questionType}) async {
    try {
      ...
      // If we have a new incorrect answer for a Sort Order question, increment
      ...
      QuizzerLogger.logError('Failed to recalculate today_so_incorrect_attempts: $e');
      rethrow;
    }
  }
  ...
  Future<int> calculateCarryForwardValue({Transaction? txn, Map<String, dynamic>? previousRecord, Map<String, dynamic>? currentIncompleteRecord}) async {
    try {
      ...
      QuizzerLogger.logError('Failed to calculate carry-forward for today_so_incorrect_attempts: $e');
      rethrow;
    }
  }
}