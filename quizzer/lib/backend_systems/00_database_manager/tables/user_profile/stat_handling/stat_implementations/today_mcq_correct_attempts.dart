...
class TodayMcqCorrectAttempts extends StatField{
  static final TodayMcqCorrectAttempts _instance = TodayMcqCorrectAttempts._internal();
  factory TodayMcqCorrectAttempts() => _instance;
  TodayMcqCorrectAttempts._internal();

  @override
  String get name => "today_mcq_correct_attempts";
  ...
  @override
  String get description => "Number of correct Multiple Choice attempts made today.";
  ...
  Future<int> recalculateStat({Transaction? txn, bool? isCorrect, double? reactionTime, String? questionId, String? questionType}) async {
    try {
      ...
      // If we have a new correct answer for an MCQ question, increment
      ...
      QuizzerLogger.logError('Failed to recalculate today_mcq_correct_attempts: $e');
      rethrow;
    }
  }
  ...
  Future<int> calculateCarryForwardValue({Transaction? txn, Map<String, dynamic>? previousRecord, Map<String, dynamic>? currentIncompleteRecord}) async {
    try {
      ...
      QuizzerLogger.logError('Failed to calculate carry-forward for today_mcq_correct_attempts: $e');
      rethrow;
    }
  }
}