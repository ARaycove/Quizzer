...
class TodaySataCorrectAttempts extends StatField{
  static final TodaySataCorrectAttempts _instance = TodaySataCorrectAttempts._internal();
  factory TodaySataCorrectAttempts() => _instance;
  TodaySataCorrectAttempts._internal();

  @override
  String get name => "today_sata_correct_attempts";
  ...
  @override
  String get description => "Number of correct Select All That Apply attempts made today.";
  ...
  Future<int> recalculateStat({Transaction? txn, bool? isCorrect, double? reactionTime, String? questionId, String? questionType}) async {
    try {
      ...
      // If we have a new correct answer for a SATA question, increment
      ...
      QuizzerLogger.logError('Failed to recalculate today_sata_correct_attempts: $e');
      rethrow;
    }
  }
  ...
  Future<int> calculateCarryForwardValue({Transaction? txn, Map<String, dynamic>? previousRecord, Map<String, dynamic>? currentIncompleteRecord}) async {
    try {
      ...
      QuizzerLogger.logError('Failed to calculate carry-forward for today_sata_correct_attempts: $e');
      rethrow;
    }
  }
}