...
class TotalTfIncorrrectAttempts extends StatField{
  static final TotalTfIncorrrectAttempts _instance = TotalTfIncorrrectAttempts._internal();
  factory TotalTfIncorrrectAttempts() => _instance;
  TotalTfIncorrrectAttempts._internal();

  @override
  String get name => "total_tf_incorrrect_attempts";
  ...
  @override
  String get description => "Total number of incorrect True/False attempts made across all time.";
  ...
  Future<int> recalculateStat({Transaction? txn, bool? isCorrect, double? reactionTime, String? questionId, String? questionType}) async {
    try {
      // If we have a new incorrect True/False answer, increment the total
      ...
      QuizzerLogger.logError('Failed to recalculate total_tf_incorrrect_attempts: $e');
      rethrow;
    }
  }
  ...
  Future<int> calculateCarryForwardValue({Transaction? txn, Map<String, dynamic>? previousRecord, Map<String, dynamic>? currentIncompleteRecord}) async {
    try {
      ...
      QuizzerLogger.logError('Failed to calculate carry-forward for total_tf_incorrrect_attempts: $e');
      rethrow;
    }
  }
}