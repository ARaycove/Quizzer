...
class TodayFitbCorrectAttempts extends StatField{
  static final TodayFitbCorrectAttempts _instance = TodayFitbCorrectAttempts._internal();
  factory TodayFitbCorrectAttempts() => _instance;
  TodayFitbCorrectAttempts._internal();

  @override
  String get name => "today_fitb_correct_attempts";
  ...
  @override
  String get description => "Number of correct Fill-in-the-blank attempts made today.";
  ...
  Future<int> recalculateStat({Transaction? txn, bool? isCorrect, double? reactionTime, String? questionId, String? questionType}) async {
    try {
      ...
      // If we have a new correct answer for a FITB question, increment
      ...
      QuizzerLogger.logError('Failed to recalculate today_fitb_correct_attempts: $e');
      rethrow;
    }
  }
  ...
  Future<int> calculateCarryForwardValue({Transaction? txn, Map<String, dynamic>? previousRecord, Map<String, dynamic>? currentIncompleteRecord}) async {
    try {
      ...
      QuizzerLogger.logError('Failed to calculate carry-forward for today_fitb_correct_attempts: $e');
      rethrow;
    }
  }
}