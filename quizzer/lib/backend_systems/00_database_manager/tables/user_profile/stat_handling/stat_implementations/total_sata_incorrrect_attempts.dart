...
class TotalSataIncorrrectAttempts extends StatField{
  static final TotalSataIncorrrectAttempts _instance = TotalSataIncorrrectAttempts._internal();
  factory TotalSataIncorrrectAttempts() => _instance;
  TotalSataIncorrrectAttempts._internal();

  @override
  String get name => "total_sata_incorrrect_attempts";
  ...
  @override
  String get description => "Total number of incorrect Select All That Apply attempts made across all time.";
  ...
  Future<int> recalculateStat({Transaction? txn, bool? isCorrect, double? reactionTime, String? questionId, String? questionType}) async {
    try {
      // If we have a new incorrect SATA answer, increment the total
      ...
      QuizzerLogger.logError('Failed to recalculate total_sata_incorrrect_attempts: $e');
      rethrow;
    }
  }
  ...
  Future<int> calculateCarryForwardValue({Transaction? txn, Map<String, dynamic>? previousRecord, Map<String, dynamic>? currentIncompleteRecord}) async {
    try {
      ...
      QuizzerLogger.logError('Failed to calculate carry-forward for total_sata_incorrrect_attempts: $e');
      rethrow;
    }
  }
}