...
class TodayTfIncorrectAttempts extends StatField{
  static final TodayTfIncorrectAttempts _instance = TodayTfIncorrectAttempts._internal();
  factory TodayTfIncorrectAttempts() => _instance;
  TodayTfIncorrectAttempts._internal();

  @override
  String get name => "today_tf_incorrect_attempts";
  ...
  @override
  String get description => "Number of incorrect True/False attempts made today.";
  ...
  Future<int> recalculateStat({Transaction? txn, bool? isCorrect, double? reactionTime, String? questionId, String? questionType}) async {
    try {
      ...
      // If we have a new incorrect answer for a True/False question, increment
      ...
      QuizzerLogger.logError('Failed to recalculate today_tf_incorrect_attempts: $e');
      rethrow;
    }
  }
  ...
  Future<int> calculateCarryForwardValue({Transaction? txn, Map<String, dynamic>? previousRecord, Map<String, dynamic>? currentIncompleteRecord}) async {
    try {
      ...
      QuizzerLogger.logError('Failed to calculate carry-forward for today_tf_incorrect_attempts: $e');
      rethrow;
    }
  }
}