...
class TodayFitbIncorrectAttempts extends StatField{
  static final TodayFitbIncorrectAttempts _instance = TodayFitbIncorrectAttempts._internal();
  factory TodayFitbIncorrectAttempts() => _instance;
  TodayFitbIncorrectAttempts._internal();

  @override
  String get name => "today_fitb_incorrect_attempts";
  ...
  @override
  String get description => "Number of incorrect Fill-in-the-blank attempts made today.";
  ...
  Future<int> recalculateStat({Transaction? txn, bool? isCorrect, double? reactionTime, String? questionId, String? questionType}) async {
    try {
      ...
      // If we have a new incorrect answer for a FITB question, increment
      ...
      QuizzerLogger.logError('Failed to recalculate today_fitb_incorrect_attempts: $e');
      rethrow;
    }
  }
  ...
  Future<int> calculateCarryForwardValue({Transaction? txn, Map<String, dynamic>? previousRecord, Map<String, dynamic>? currentIncompleteRecord}) async {
    try {
      ...
      QuizzerLogger.logError('Failed to calculate carry-forward for today_fitb_incorrect_attempts: $e');
      rethrow;
    }
  }
}