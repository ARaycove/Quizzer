...
class TodayCorrectAttempts extends StatField{
  static final TodayCorrectAttempts _instance = TodayCorrectAttempts._internal();
  factory TodayCorrectAttempts() => _instance;
  TodayCorrectAttempts._internal();

  @override
  String get name => "today_correct_attempts";
  ...
  @override
  String get description => "Number of correct attempts made today.";
  ...
  Future<int> recalculateStat({Transaction? txn, bool? isCorrect, double? reactionTime, String? questionId, String? questionType}) async {
    try {
      ...
      // If we have a new correct answer, increment
      ...
      QuizzerLogger.logError('Failed to recalculate today_correct_attempts: $e');
      rethrow;
    }
  }
  ...
  Future<int> calculateCarryForwardValue({Transaction? txn, Map<String, dynamic>? previousRecord, Map<String, dynamic>? currentIncompleteRecord}) async {
    try {
      ...
      QuizzerLogger.logError('Failed to calculate carry-forward for today_correct_attempts: $e');
      rethrow;
    }
  }
}