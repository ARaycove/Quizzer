...
class TotalMcqIncorrrectAttempts extends StatField{
  static final TotalMcqIncorrrectAttempts _instance = TotalMcqIncorrrectAttempts._internal();
  factory TotalMcqIncorrrectAttempts() => _instance;
  TotalMcqIncorrrectAttempts._internal();

  @override
  String get name => "total_mcq_incorrrect_attempts";
  ...
  @override
  String get description => "Total number of incorrect Multiple Choice attempts made across all time.";
  ...
  Future<int> recalculateStat({Transaction? txn, bool? isCorrect, double? reactionTime, String? questionId, String? questionType}) async {
    try {
      // If we have a new incorrect MCQ answer, increment the total
      ...
      QuizzerLogger.logError('Failed to recalculate total_mcq_incorrrect_attempts: $e');
      rethrow;
    }
  }
  ...
  Future<int> calculateCarryForwardValue({Transaction? txn, Map<String, dynamic>? previousRecord, Map<String, dynamic>? currentIncompleteRecord}) async {
    try {
      ...
      QuizzerLogger.logError('Failed to calculate carry-forward for total_mcq_incorrrect_attempts: $e');
      rethrow;
    }
  }
}