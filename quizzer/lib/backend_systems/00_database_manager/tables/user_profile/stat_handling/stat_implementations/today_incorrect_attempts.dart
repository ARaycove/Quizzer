...
class TodayIncorrectAttempts extends StatField{
  static final TodayIncorrectAttempts _instance = TodayIncorrectAttempts._internal();
  factory TodayIncorrectAttempts() => _instance;
  TodayIncorrectAttempts._internal();

  @override
  String get name => "today_incorrect_attempts";
  ...
  @override
  String get description => "Number of incorrect attempts made today (all question types).";
  ...
  Future<int> recalculateStat({Transaction? txn, bool? isCorrect, double? reactionTime, String? questionId, String? questionType}) async {
    try {
      ...
      // If we have a new incorrect answer (regardless of question type), increment
      ...
      QuizzerLogger.logError('Failed to recalculate today_incorrect_attempts: $e');
      rethrow;
    }
  }
  ...
  Future<int> calculateCarryForwardValue({Transaction? txn, Map<String, dynamic>? previousRecord, Map<String, dynamic>? currentIncompleteRecord}) async {
    try {
      ...
      QuizzerLogger.logError('Failed to calculate carry-forward for today_incorrect_attempts: $e');
      rethrow;
    }
  }
}