...
class TodaySoCorrectAttempts extends StatField{
  static final TodaySoCorrectAttempts _instance = TodaySoCorrectAttempts._internal();
  factory TodaySoCorrectAttempts() => _instance;
  TodaySoCorrectAttempts._internal();

  @override
  String get name => "today_so_correct_attempts";
  ...
  @override
  String get description => "Number of correct Sort Order attempts made today.";
  ...
  Future<int> recalculateStat({Transaction? txn, bool? isCorrect, double? reactionTime, String? questionId, String? questionType}) async {
    try {
      ...
      // If we have a new correct answer for a Sort Order question, increment
      ...
      QuizzerLogger.logError('Failed to recalculate today_so_correct_attempts: $e');
      rethrow;
    }
  }
  ...
  Future<int> calculateCarryForwardValue({Transaction? txn, Map<String, dynamic>? previousRecord, Map<String, dynamic>? currentIncompleteRecord}) async {
    try {
      ...
      QuizzerLogger.logError('Failed to calculate carry-forward for today_so_correct_attempts: $e');
      rethrow;
    }
  }
}