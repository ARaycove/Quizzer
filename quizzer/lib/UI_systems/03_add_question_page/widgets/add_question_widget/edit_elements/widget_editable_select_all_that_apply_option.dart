...
// ==========================================
//    Editable Select All That Apply Option Widget
// ==========================================
// Handles individual SATA options with checkbox selection

class EditableSelectAllThatApplyOption extends StatefulWidget {
  ...
  final Function(int index) onToggleCorrect;

  const EditableSelectAllThatApplyOption({
    super.key,
  ...
  @override
  State<EditableSelectAllThatApplyOption> createState() => _EditableSelectAllThatApplyOptionState();
}

class _EditableSelectAllThatApplyOptionState extends State<EditableSelectAllThatApplyOption> {
  ...
  void _submitEdit() {
    ...
    QuizzerLogger.logMessage("Submitting edit for SATA option at index ${widget.index}");
      ...
      child: GestureDetector(
        onDoubleTap: () {
          ...
          if (widget.element['type'] == 'text') {
            QuizzerLogger.logMessage("Starting edit for SATA option at index ${widget.index}");
            _startEditing();
          } else if (widget.element['type'] == 'image') {
            QuizzerLogger.logWarning("Double-tap image edit (replacement) not implemented yet for SATA options.");
          }
        },
        child: ListTile(
          dense: true,
          ...
          leading: IconButton(
            icon: Icon(
              widget.isCorrect ? Icons.check_box : Icons.check_box_outline_blank,
            ),
            tooltip: 'Toggle Correct Answer',
            onPressed: () => widget.onToggleCorrect(widget.index),
