...
//         final dynamic correctIndexRaw = questionMap['correctOptionIndex']; // Can be int or String
...
//           continue;
//         }
//         options = optionsRaw.map((o) => o.toString()).toList(); // Convert all options to strings
...
//          await _session.addQuestionAnswerPair(
//            timeStamp: timeStamp,
//            questionElements: questionElements,
//            answerElements: answerElements,
//            moduleName: moduleName,
//            questionType: questionType,
//            sourcePaths: null, // TODO: Handle potential source paths if needed in JSON?
//            options: options, // Will be null if not multiple_choice
//            correctOptionIndex: correctOptionIndex, // Will be null if not multiple_choice
//          );
//          successCount++;
...
//             color: ColorWheel.buttonSuccess, // Use success color
//           ) // Show loading indicator
//         : IconButton(
//             icon: const Icon(Icons.upload_file, size: 24.0),
//             color: ColorWheel.buttonSuccess,
//             tooltip: 'Bulk Add Questions from JSON file',
//             onPressed: () => _handleBulkAdd(context),
//           );
//   }
// } 
