...
class _ResetPasswordPageState extends State<ResetPasswordPage> {
  ...
  Future<void> _verifyOtp() async {
    ...
    try {
      final res = await SessionManager().supabase.auth.verifyOTP(
  ...
  Future<void> _submitNewPassword() async {
    ...
    try {
      QuizzerLogger.logMessage('Attempting Supabase password reset');
      final response = await SessionManager().supabase.auth.updateUser(
        UserAttributes(
          password: newPass,
        ),
      );
