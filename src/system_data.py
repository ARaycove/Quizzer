...
def get_next_question(user_profile_data, amount_of_rs_one_questions):
    ...
    for i in range(1, 101):
        for question_id, question_object_user_data in user_questions.items():
            ...
            #   Any question with a value of 1-4 will be selected,
            # Once revision one questions are exhausted, range goes to 2-5
            # Then 3-6, 4-7, 5-8 and so on.
            # This algorithm prioritizes new knowledge over old knowledge, if time is limited, system will focus on teaching new things over reminding of old things
            if prioritize_rs_one_questions == True and check_var == 1:
