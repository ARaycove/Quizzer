...
def write_module_questions_to_users_questions(raw_master_question_list: dict, user_profile_data: dict) -> dict:
    '''
...
def build_activated_setting(modules_list: dict, user_profile_data: dict) -> dict:
    '''
